...
public class MacroManager {
    ...
    public static ParsingLink createNewLink(MacroExpression macroExpression) throws CannotCompileException, RuntimeException,
        ...
        String template =
                "public java.util.regex.Pattern pattern = java.util.regex.Pattern.compile("
                        + InternalRepresentation.convert(macroExpression.getRegex()) + ");";
        ...
        template =
                "public com.surftheedge.tesseract.expression.Expression execute(String expression) {"
                        ...
                        + "String evalPattern = "
                        + InternalRepresentation.convert("(%|&)\\{(([^}]*\\\\\\}[^}]*)+|[^}]+)\\}")
                        + ";"
                        ...
                        + "}" + "}" + "coreReplacer.appendTail(buf);" + "String result2 = buf.toString();"
