            ...
            public Class execute() throws Exception {
                ...
                if (rf.getInterceptor().getName().split("\\.").length > 1) {
                    String packageAndClass =
                            rf.getInterceptor().getName().substring(0, rf.getInterceptor().getName().lastIndexOf("."));
                ...
                Method interceptor =
                        theOtherClass.getMethod(
                                rf.getInterceptor().getName().substring(rf.getInterceptor().getName().lastIndexOf(".") + 1),
                                interceptorArgs);
